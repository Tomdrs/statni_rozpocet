...
class Expenses:
    def __init__(self, record):
        ...
        self.noninvestment_soc_and_health_funds = (
            record.noninvestment_soc_and_health_funds
        )
...
class State_levies_average:
    def __init__(self, record):
        ...
        self.vat_books_music_medicine_water_accomodations = (
            record.vat_books_music_medicine_water_accomodations
        )
