...
def yearly_income_tax(gross, is_supergross):
    if is_supergross == True and gross > 17133:
        ...
        return (
            (income_tax_multiplier * super_gross - 2570) * 12 * budgetary_determination
        )
    elif gross > 17133:
...
def yearly_total_tax(
    ...
    return (
        yearly_income_tax(gross, is_supergross)
...
def noninvestment_transfers_to_bussines(
    total_expenses, yearly_total_tax, non_transfers
):
