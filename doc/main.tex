...
% Abstrakt anglicky
\def\AbstraktEN{%
The goal of the prohttps://www.youtube.com/watch?v=gbqBGeeScbsject is to create a web application, that will serve as a calculator of an individual's participation in the state budget of Czech Republic. The user will
